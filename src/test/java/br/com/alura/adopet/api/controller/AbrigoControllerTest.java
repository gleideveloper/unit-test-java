...
import static br.com.alura.adopet.api.model.TipoPet.GATO;
...
class AbrigoControllerTest {
    ...
    @Test
    @DisplayName("Deveria listar abrigos e devolver codigo 200 para a requisicao")
    ...
    void deveriaDevolverCodigo200ParaRequisicaoDeCadastrarAbrigo() throws Exception {
        //ARRANGE
        var dto = new CadastroAbrigoDto("Abrigo feliz", "(94)0000-9090", "email@example.com.br");
    ...
    void deveriaDevolverCodigo400ParaRequisicaoDeCadastrarAbrigo() throws Exception {
        //ARRANGE
        var dto = new CadastroAbrigoDto("Abrigo feliz", "(94)0000-90900", "email@example.com.br");
    ...
    void deveriaDevolverCodigo200ParaRequisicaoDeCadastrarPetPeloId() throws Exception {
        //Arange
         var petDto = new CadastroPetDto(GATO, "Miau", "padrao", 5, "Parda", 6.4F);
        ...
        MockHttpServletResponse response = mockMvc.perform(
                post("/abrigos/{abrigoId}/pets",abrigoId)
                        .content(jsonDto.write(petDto).getJson())
                        .contentType(MediaType.APPLICATION_JSON)
        ).andReturn().getResponse();
